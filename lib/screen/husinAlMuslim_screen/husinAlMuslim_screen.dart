    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          //     title: key , leading: '${index + 1}' , fun: (){AwesomeDialog(
          //     context: context ,
          //     dialogBackgroundColor: MyTheme.primaryColor ,
          //     dialogType: DialogType.noHeader,
          //     // desc: meaning,
          //     descTextStyle: TextStyle(color: Colors.white ,height: 1.5 , fontSize: 16),
          //     title: key,
          //     desc: husinAlMuslim[key]['text'][0],
            ...
            child: InkWell(
                onTap: (){
                  AwesomeDialog(
                      ...
                      dialogType: DialogType.noHeader,
                      // desc: meaning,
                      descTextStyle: const TextStyle(color: Colors.white ,height: 1.5 , fontSize: 16),
                      title: key,
                      desc: husinAlMuslim[key]['text'][0],
