  ...
  Widget build(BuildContext context) {
    return Screenshot(
      ...
      child: QuranLibraryScreen(
        ...
        backgroundColor: isDarkMode ? const Color(0xff181818) : const Color(0xfffffbec),
        textColor: isDarkMode ? Colors.white : Colors.black,
        ayahIconColor: isDarkMode ? Colors.white : MyTheme.primaryColor,
        ayahSelectedBackgroundColor: MyTheme.primaryColor.withValues(alpha: 0.15),
      ),
    );
  }
}
