...
import 'package:thekr_app/widget.dart';
...
class AsmaAllahScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomContainer(title: name , leading: '${index + 1}' ,fun: (){
      AwesomeDialog(
          context: context ,
          dialogBackgroundColor: MyTheme.primaryColor ,
          dialogType: DialogType.noHeader,
          desc: meaning,
          descTextStyle: const TextStyle(color: Colors.white ,height: 1.5 , fontSize: 17 ),
          title: name,
          titleTextStyle: const TextStyle(color: Colors.orange , fontSize: 20 , fontWeight: FontWeight.bold)
      ).show();
    }, );
    }
    )
...
final  Map<String, dynamic> asmaAllah = {
  ...
  'العَلِيم': 'يعلم تفاصيل الأمور، ودقائق الأشياء، وخفايا الضمائر، والنفوس، لا يعزب عنه مثقال ذرة، فعلمه يحيط بجميع الأشياء.',
  ...
  'الْغَفُورُ': 'الساتر لذنوب عباده المتجاوز عن خطاياهم وذنوبهم، الفرق بين هذا الاسم واسم الغفار: أنّ اسم الغفور يكون للدلالة على مغفرة الذنب مهما عظم وأيس صاحبه من المغفرة، أمّا الغفار فتدل على مغفرة الله المستمرة للذنوبالمختلفة لأن الإنسان خطاء فالله غفار.',
